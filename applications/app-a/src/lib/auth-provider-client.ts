...
const OAUTH_CLIENT_ID = process.env.OAUTH_CLIENT_ID ?? "app-a";
const OAUTH_CLIENT_SECRET = process.env.OAUTH_CLIENT_SECRET ?? "app-a-secret";
const OAUTH_REDIRECT_URI = process.env.OAUTH_REDIRECT_URI ?? "http://localhost:4000/callback";
